...
interface INFTWorldExchange {
    ...
    function depositWearables(string memory _collectionName, uint256[] _tokenIds) external;

    function withdrawWearables(string memory _collectionName, uint256[] _tokenIds) external;
